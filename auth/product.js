...
router.put('/update', upload.array('images', 5), async (req, res) => {
    ...
    try {
        ...
        if (discount_amount !== undefined) fieldsToUpdate.discount_amount = discount_amount ? parseFloat(discount_amount) : null;
        ...
        // Update Categories, Types, and Options (same as your current logic)
        // ...
